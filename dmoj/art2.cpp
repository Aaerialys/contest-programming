...
ull fpow(ull a,ull b){if(!b) return 1; ull t=fpow(a,b/2); if(b&1) return t*t%P2(32)*a%P2(32); return t*t%P2(32);}
...
const ll N=300010,M=P2(32),I=244002641;
ll n,m,v[N];

...
string add(string a,string b){
    if(sz(a)<sz(b)) a.insert(0,sz(b)-sz(a),'0');
    if(sz(b)<sz(a)) b.insert(0,sz(a)-sz(b),'0');
    string ret=""; int cur,nxt=0;
    ford(i,sz(a)-1,0){
        cur=a[i]-'0'+b[i]-'0'+nxt;
        ret=to_string(cur%10)+ret;
        nxt=cur/10;
    }
    if(nxt) ret=char(nxt+'0')+ret;
    return ret;
}
...
int main(){
    ...
    ull a,b,c; cin>>a>>b>>c; cout<<(a+b+c)%42069900169420; return 0;
    return 0;
}
/**
